...
---
[DAX Formatter](https://www.daxformatter.com) is a free service by SQLBI that formats DAX expressions according to the [rules for DAX code formatting](../dax-style/dax-format.md). All the formatting happens server-side at `https://api.daxformatter.com`: the tools described here are clients, transports, and integrations around that single service.
