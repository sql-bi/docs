...
└── UtcEnd : DateTime
```
- [QueryGroupsCollection](./QueryGroupsCollection.md) → *contains multiple* `QueryGroup`
- QueryGroup → *references* [`ModelDependency`](./ModelDependency.md)
- QueryGroup → *references* [`Item`](./Item.md)
- QueryGroup → *references* [`TableDependency`](./TableDependency.md), [`ColumnDependency`](./ColumnDependency.md), [`MeasureDependency`](./MeasureDependency.md)
