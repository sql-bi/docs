...
2) Click on the **Enroll Now**, **Subscribe**, or **Add To Cart** button, depending on the service selected.<br/><img src="images/enroll-now-subscribe-add-to-cart-buttons.png" width="600" alt="Enroll Now and Add To Cart Button">

3) Select the **Quote** switch close to the Order Details section. This will create a quote instead of an order.<br/><img src="images/quote-option.png" width="350" alt="Quote Option">
...
10) **Agree** to the terms and conditions. The option is not binding for the quote only, because you are not purchasing nor trying any service by simply requesting a quote. We just want to make sure you understand the Terms and Conditions for the quote. <br/><img src="images/create-quote-button.png" width="420" alt="Create Quote Button">
