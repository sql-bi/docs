...
const daxKeywords = 'WITH VISUAL SHAPE|AXIS COLUMNS|MPARAMETER|AXIS ROWS|EVALUATE|FUNCTION|ORDER BY|START AT|DENSIFY|MEASURE|VARIANT|ANYREF|ANYVAL|COLUMN|DEFINE|RETURN|SCALAR|GROUP|TABLE|TOTAL|EXPR|VAL|VAR';
